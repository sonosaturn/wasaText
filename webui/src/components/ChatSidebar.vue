...
export default {
  ...
  methods: {
    ...
    startEdit() {
      ...
      // Automatic focus on the input when it appears
      this.$nextTick(() => {
    ...
    saveName() {
      // FIX 1: If we're no longer editing (e.g. submit already closed it), exit immediately.
      // This blocks the second event (blur) generated by the alert opening.
      ...
      // FIX 2: Close editing BEFORE emitting the event.
      // This way the input disappears from the DOM and can't generate other events.
      this.isEditingName = false
